  ...
  const projects = [
    {
      ...
      description: "Modern car rental platform with booking system, user authentication, and responsive design built with React and modern web technologies.",
      longDescription: "A comprehensive car rental application featuring user registration/login, car browsing with filters, booking management, payment integration, and admin dashboard. Built with React.js frontend and includes features like real-time availability, booking history, and responsive design for all devices.",
      image: "/api/placeholder/600/400",
      technologies: ["React.js", "JavaScript", "CSS3", "Responsive Design", "API Integration"],
      liveUrl: "https://car-rental-flame-xi.vercel.app/",
      githubUrl: "#",
      featured: true,
    ...
    },
    {
      ...
      description: "Dynamic QR code generator with customization options, multiple formats, and instant download functionality.",
      longDescription: "A powerful QR code generator application that allows users to create QR codes for various types of content including URLs, text, contact information, and more. Features include customizable colors, sizes, error correction levels, and instant download in multiple formats.",
      image: "/api/placeholder/600/400",
      technologies: ["React.js", "JavaScript", "QR Code API", "CSS3", "File Download"],
      liveUrl: "https://qrcode-generator-snowy.vercel.app/",
      githubUrl: "#",
      featured: true,
    ...
    },
    {
      ...
      description: "Comprehensive capstone project showcasing advanced web development skills and modern technologies.",
      longDescription: "A full-featured capstone project developed as part of academic curriculum, demonstrating proficiency in modern web development technologies, database management, user interface design, and project management. Includes advanced features like user authentication, data visualization, and responsive design.",
      image: "/api/placeholder/600/400",
      technologies: ["React.js", "Node.js", "Database", "Authentication", "Responsive Design"],
      liveUrl: "https://capstone-sem2-eta.vercel.app/",
      githubUrl: "#",
      featured: true,
